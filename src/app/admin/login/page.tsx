 ...
 * 管理者向けログインページ
 * - Auth0認証を使用したログイン機能
 * - Admin-DB connectionを使用
 * - ログイン後のリダイレクト先は /admin
 */
'use client';
...
const AdminLoginPage: React.FC = () => {
  ...
  const handleLogin = () => {
    // Admin-DB connection 指定、ログイン後に /admin へ
    router.push('/api/auth/admin-login');
  };
      ...
      <main className="flex-grow flex items-center justify-center bg-gray-50">
        <div className="w-full max-w-md p-6 space-y-8 bg-white shadow rounded-lg">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">管理者アカウントでシステムにアクセス</p>
          </div>
